...
const Skills = (() => {
  ...
  /* The filter box. Esc clears the filter rather than closing the whole
   * screen, as long as there is something to clear; every other key is kept off
   * the document-level shortcut handler, since a bare Tab there would move
   * focus into a terminal mid-typing. */
